...
const SelectedInput = ({ label = 'Label', placeholder = 'Placeholder', type = 'text', value = '' }) => {
    return (
        <div className="relative flex flex-col self-stretch">
            <input className="flex items-center self-stretch gap-[10px] text-xl peer bg-transparent  border rounded py-4 px-3 outline-none border-twitter-blue text-neutral-50" placeholder={placeholder} type={type} value={value} />
